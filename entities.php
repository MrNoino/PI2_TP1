...
if(isset($_SESSION["food_saver_lang"])){
    ...
    //se sim
    if(file_exists("src/languages/". $_SESSION["food_saver_lang"] ."/i18n_nav_". $_SESSION["food_saver_lang"] .".php") && file_exists("src/languages/". $_SESSION["food_saver_lang"] ."/i18n_entities_". $_SESSION["food_saver_lang"] .".php") && file_exists("src/languages/". $_SESSION["food_saver_lang"] ."/i18n_footer_". $_SESSION["food_saver_lang"] .".php")){
        ...
        include_once("src/languages/". $_SESSION["food_saver_lang"] ."/i18n_entities_". $_SESSION["food_saver_lang"] .".php");
    ...
    //senao
        ...
        include_once("src/languages/pt-PT/i18n_entities_pt-PT.php");
